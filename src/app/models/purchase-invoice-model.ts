...
import {PurchaseInvoiceMainModel} from './purchase-invoice-main-model';
...
export const setInvoiceCalculation = (record: PurchaseInvoiceMainModel, list: Array<PurchaseInvoiceDetailMainModel>): void => {
  let a = 0;
  let b = 0;
  let c = 0;
